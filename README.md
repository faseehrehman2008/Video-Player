...
Progress Tracking – Interactive progress bar with real-time time display (HH:MM:SS)

Keyboard Shortcuts – Space (play/pause), Escape (stop), Arrow keys (seek/volume)
